...
extern void mali_session_memory_tracking_lmk(void);
extern void lmk_register_track_fun(char* module, mem_track fun);
...
int mali_module_init(void)
{
	...
	/* ACOS_MOD_BEGIN {fwk_crash_log_collection} */
	//register dump function to lmk.
	lmk_register_track_fun("mali", mali_session_memory_tracking_lmk);
	/* ACOS_MOD_END {fwk_crash_log_collection} */
	return 0; /* Success */
}
