...
/* Portions of this file are copyright 2017 by Amazon.com, Inc. or its
 * affiliates.
 * All rights reserved.
 */
...
struct thermal_zone_device_ops {
	...
	int (*set_ntrips) (struct thermal_zone_device *, int, int *);
	...
	int (*notify) (struct thermal_zone_device *, int,
		       enum thermal_trip_type);
	int (*set_polling) (struct thermal_zone_device *, int);
};
...
struct thermal_cooling_device_ops {
	...
	int (*notify_state)(struct thermal_cooling_device *,
			    ...
			    enum thermal_trip_type);
	/**
	 * Optional interface to allow lookup from more human-friendly units
	 * to internal states. E.g. from frequency to the associated state.
	 */
	int (*map_action_to_state)(struct thermal_cooling_device *,
				   unsigned long,
				   unsigned long *);
#endif
};
