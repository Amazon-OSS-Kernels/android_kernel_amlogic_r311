 ...
 */
	...
	/* This goes hand in hand with /sys/module/am_vecm/parameters/sdr_mode
	 * setting done by user space
	 */
	if ((hdev->hdr_color_feature == C_BT2020) ||
		(hdev->hdmi_info.vsdb_phy_addr.a
		 && hdev->hdmi_info.vsdb_phy_addr.b
		 && hdev->RXCap.hdr_sup_eotf_smpte_st_2084))
