...
/*ary move from demod_func.c*/
void enable_qam_int(int idx)
{
	unsigned long mask;

	mask = dvbc_read_reg(QAM_BASE + 0xd0);
	mask |= (1 << idx);
	dvbc_write_reg(QAM_BASE + 0xd0, mask);
}
...
u32 dvbc_set_qam_mode(unsigned char mode)
{
	...
	dvbc_write_reg(QAM_BASE + 0x008, (mode & 7));
	/* qam mode */
	switch (mode) {
	case 0:		/* 16 QAM */
		dvbc_write_reg(QAM_BASE + 0x054, 0x23460224);
		/* EQ_FIR_CTL, */
		dvbc_write_reg(QAM_BASE + 0x068, 0x00c000c0);
		/* EQ_CRTH_SNR */
		dvbc_write_reg(QAM_BASE + 0x074, 0x50001a0);
		/* EQ_TH_LMS  40db      13db */
		dvbc_write_reg(QAM_BASE + 0x07c, 0x003001e9);
		/* EQ_NORM and EQ_TH_MMA */
		/*dvbc_write_reg(QAM_BASE+0x080, 0x000be1ff);
		 * // EQ_TH_SMMA0*/
		dvbc_write_reg(QAM_BASE + 0x080, 0x000e01fe);
		/* EQ_TH_SMMA0 */
		dvbc_write_reg(QAM_BASE + 0x084, 0x00000000);
		/* EQ_TH_SMMA1 */
		dvbc_write_reg(QAM_BASE + 0x088, 0x00000000);
		/* EQ_TH_SMMA2 */
		dvbc_write_reg(QAM_BASE + 0x08c, 0x00000000);
		/* EQ_TH_SMMA3 */
		 ...
		 * // Pilips Tuner*/
		dvbc_write_reg(QAM_BASE + 0x094, 0x7f80092d);
		/* Pilips Tuner */
	...
	case 1:		/* 32 QAM */
		dvbc_write_reg(QAM_BASE + 0x054, 0x24560506);
		/* EQ_FIR_CTL, */
		dvbc_write_reg(QAM_BASE + 0x068, 0x00c000c0);
		/* EQ_CRTH_SNR */
		/*dvbc_write_reg(QAM_BASE+0x074, 0x5000260);
		 * // EQ_TH_LMS      40db  19db*/
		dvbc_write_reg(QAM_BASE + 0x074, 0x50001f0);
		/* EQ_TH_LMS  40db      17.5db */
		dvbc_write_reg(QAM_BASE + 0x07c, 0x00500102);
		/* EQ_TH_MMA  0x000001cc */
		dvbc_write_reg(QAM_BASE + 0x080, 0x00077140);
		/* EQ_TH_SMMA0 */
		dvbc_write_reg(QAM_BASE + 0x084, 0x001fb000);
		/* EQ_TH_SMMA1 */
		dvbc_write_reg(QAM_BASE + 0x088, 0x00000000);
		/* EQ_TH_SMMA2 */
		dvbc_write_reg(QAM_BASE + 0x08c, 0x00000000);
		...
		/*dvbc_write_reg(QAM_BASE+0x094, 0x7f80292b);
		 * // Pilips Tuner*/
		dvbc_write_reg(QAM_BASE + 0x094, 0x7f80092b);
		/* Pilips Tuner */
		dvbc_write_reg(QAM_BASE + 0x0c0, 0x061f2f66);
		/* by raymond 20121213 */
		break;
	...
	case 2:		/* 64 QAM */
		 ...
		 * // EQ_FIR_CTL,*/
		dvbc_write_reg(QAM_BASE + 0x054, 0x2336043a);
		/* EQ_FIR_CTL, by raymond */
		dvbc_write_reg(QAM_BASE + 0x068, 0x00c000c0);
		/* EQ_CRTH_SNR */
		/*dvbc_write_reg(QAM_BASE+0x074, 0x5000260);
		 * // EQ_TH_LMS  40db  19db*/
		dvbc_write_reg(QAM_BASE + 0x074, 0x5000230);
		/* EQ_TH_LMS  40db      17.5db */
		dvbc_write_reg(QAM_BASE + 0x07c, 0x007001bd);
		/* EQ_TH_MMA */
		dvbc_write_reg(QAM_BASE + 0x080, 0x000580ed);
		/* EQ_TH_SMMA0 */
		dvbc_write_reg(QAM_BASE + 0x084, 0x001771fb);
		/* EQ_TH_SMMA1 */
		dvbc_write_reg(QAM_BASE + 0x088, 0x00000000);
		/* EQ_TH_SMMA2 */
		dvbc_write_reg(QAM_BASE + 0x08c, 0x00000000);
		...
		dvbc_write_reg(QAM_BASE + 0x094, 0x7f802b3d);
	...
	case 3:		/* 128 QAM */
		 ...
		 * // EQ_FIR_CTL,*/
		dvbc_write_reg(QAM_BASE + 0x054, 0x2437067a);
		/* EQ_FIR_CTL, by raymond 20121213 */
		dvbc_write_reg(QAM_BASE + 0x068, 0x00c000d0);
		/* EQ_CRTH_SNR */
		 ...
		 * // EQ_TH_MMA0x000000b2*/
		dvbc_write_reg(QAM_BASE + 0x07c, 0x00b00132);
		/* EQ_TH_MMA0x000000b2 by raymond 20121213 */
		dvbc_write_reg(QAM_BASE + 0x080, 0x0003a09d);
		/* EQ_TH_SMMA0 */
		dvbc_write_reg(QAM_BASE + 0x084, 0x000f8150);
		/* EQ_TH_SMMA1 */
		dvbc_write_reg(QAM_BASE + 0x088, 0x001a51f8);
		/* EQ_TH_SMMA2 */
		dvbc_write_reg(QAM_BASE + 0x08c, 0x00000000);
		/* EQ_TH_SMMA3 */
		/*dvbc_write_reg(QAM_BASE+0x094, 0x7f800d2c);
		...
		/*dvbc_write_reg(QAM_BASE+0x094, 0x7f80292c);
		 * // Pilips Tuner*/
		dvbc_write_reg(QAM_BASE + 0x094, 0x7f80092c);
		/* Pilips Tuner */
		dvbc_write_reg(QAM_BASE + 0x0c0, 0x061f2f66);
		/* by raymond 20121213 */
		break;
	...
	case 4:		/* 256 QAM */
		 ...
		 * // EQ_FIR_CTL,*/
		dvbc_write_reg(QAM_BASE + 0x054, 0xa25905f9);
		/* EQ_FIR_CTL, by raymond 20121213 */
		dvbc_write_reg(QAM_BASE + 0x068, 0x01e00220);
		/* EQ_CRTH_SNR */
		/*dvbc_write_reg(QAM_BASE+0x074,  0x50002a0);
		 * // EQ_TH_LMS      40db  19db*/
		dvbc_write_reg(QAM_BASE + 0x074, 0x5000270);
		/* EQ_TH_LMS  40db      19db by raymond 201211213 */
		dvbc_write_reg(QAM_BASE + 0x07c, 0x00f001a5);
		/* EQ_TH_MMA */
		dvbc_write_reg(QAM_BASE + 0x080, 0x0002c077);
		/* EQ_TH_SMMA0 */
		dvbc_write_reg(QAM_BASE + 0x084, 0x000bc0fe);
		/* EQ_TH_SMMA1 */
		dvbc_write_reg(QAM_BASE + 0x088, 0x0013f17e);
		/* EQ_TH_SMMA2 */
		dvbc_write_reg(QAM_BASE + 0x08c, 0x01bc01f9);
		/* EQ_TH_SMMA3 */
		/*dvbc_write_reg(QAM_BASE+0x094, 0x7f800d2c);
		 * // AGC_CTRL  ALPS tuner*/
		/*dvbc_write_reg(QAM_BASE+0x094, 0x7f80292c);
		...
		dvbc_write_reg(QAM_BASE + 0x094, 0x7f80092d);
		/* Maxlinear Tuner */
		dvbc_write_reg(QAM_BASE + 0x0c0, 0x061f2f67);
...
static void dvbc_sw_reset(int addr, int idx)
{
	...
	tmp = dvbc_read_reg(QAM_BASE + addr);

	tmp &= ~(1 << idx);
	dvbc_write_reg(QAM_BASE + addr, tmp);
...
/*		dvbc_write_reg(DEMOD_CFG_BASE,0x00000007);*/
	/* disable irq */
	dvbc_write_reg(QAM_BASE + 0xd0, 0);

	/* reset */
	/*dvbc_reset(); */
	dvbc_write_reg(QAM_BASE + 0x4,
				dvbc_read_reg(QAM_BASE + 0x4) & ~(1 << 4));
	/* disable fsm_en */
	dvbc_write_reg(QAM_BASE + 0x4,
				dvbc_read_reg(QAM_BASE + 0x4) & ~(1 << 0));
	/* Sw disable demod */
	dvbc_write_reg(QAM_BASE + 0x4,
				dvbc_read_reg(QAM_BASE + 0x4) | (1 << 0));
	/* Sw enable demod */

	dvbc_write_reg(QAM_BASE + 0x000, 0x00000000);
	/* QAM_STATUS */
	dvbc_write_reg(QAM_BASE + 0x004, 0x00000f00);
	/* QAM_GCTL0 */
	dvbc_write_reg(QAM_BASE + 0x008, (ch_mode & 7));
	/* qam mode */
	 ...
	 * // adc_cnt, symb_cnt*/
	dvbc_write_reg(QAM_BASE + 0x00c, 0xffff8ffe);
	...
	if (afifo_ctr > 255)
		afifo_ctr = 255;
	dvbc_write_reg(QAM_BASE + 0x010, (afifo_ctr << 16) | 8000);
	/* afifo, rs_cnt_cfg */
	...
	dvbc_write_reg(QAM_BASE + 0x020, 0x61b53e54);
	...
	/* dprintk("phs_cfg = %x\n", phs_cfg); */
	dvbc_write_reg(QAM_BASE + 0x024, 0x4c000000 | (phs_cfg & 0x7fffff));
	...
	dvbc_write_reg(QAM_BASE + 0x02c, max_frq_off & 0x3fffffff);
...
/* configure symbol rate step step 0*/
	...
	dvbc_write_reg(QAM_BASE + 0x048, 3400 * 256);
	/* configure min symbol_rate fb = 6.95M */
...
/************* hw state machine config **********/
	...
	dvbc_write_reg(QAM_BASE + 0x04c, 0x00008800);	/* reserved */

	/*dvbc_write_reg(QAM_BASE+0x050, 0x00000002);  // EQ_CTL0 */
	dvbc_write_reg(QAM_BASE + 0x050, 0x01472002);
	/* EQ_CTL0 by raymond 20121208 */

	/*dvbc_write_reg(QAM_BASE+0x058, 0xff550e1e);  // EQ_FIR_INITPOS */
	dvbc_write_reg(QAM_BASE + 0x058, 0xff100e1e);
	/* EQ_FIR_INITPOS for skyworth */

	dvbc_write_reg(QAM_BASE + 0x05c, 0x019a0000);	/* EQ_FIR_INITVAL0 */
	dvbc_write_reg(QAM_BASE + 0x060, 0x019a0000);	/* EQ_FIR_INITVAL1 */

	/*dvbc_write_reg(QAM_BASE+0x064, 0x01101128);  // EQ_CRTH_TIMES */
	dvbc_write_reg(QAM_BASE + 0x064, 0x010a1128);
	/* EQ_CRTH_TIMES for skyworth */
	dvbc_write_reg(QAM_BASE + 0x06c, 0x00041a05);	/* EQ_CRTH_PPM */

	dvbc_write_reg(QAM_BASE + 0x070, 0xffb9aa01);	/* EQ_CRLP */

	/*dvbc_write_reg(QAM_BASE+0x090, 0x00020bd5); // agc control */
	dvbc_write_reg(QAM_BASE + 0x090, 0x00000bd5);	/* agc control */
	...
	if ((agc_mode & 1) == 0)
		...
		dvbc_write_reg(QAM_BASE + 0x094,
				  dvbc_read_reg(QAM_BASE + 0x94) | (0x1 << 10));
	if ((agc_mode & 2) == 0) {
		/* IF control */
		/*freeze rf agc */
		dvbc_write_reg(QAM_BASE + 0x094,
				  dvbc_read_reg(QAM_BASE + 0x94) | (0x1 << 13));
	}
	/*Maxlinear Tuner */
	/*dvbc_write_reg(QAM_BASE+0x094, 0x7f80292d); */
	...
	dvbc_write_reg(QAM_BASE + 0x0a0, 0x0603cd10);
	/* AGC_RFGAIN_CTRL 0x0e020800 by raymond,
	 * if Adjcent channel test, maybe it need change.
	 * 20121208 ad invert,20130221, suit for two path channel.*/

	dvbc_write_reg(QAM_BASE + 0x004,
			dvbc_read_reg(QAM_BASE + 0x004) | 0x33);
	/* IMQ, QAM Enable */
	...
	dvbc_write_reg(QAM_BASE + 0x4,
			dvbc_read_reg(QAM_BASE + 0x4) | (1 << 4));
	dvbc_write_reg(QAM_BASE + 0x0e8,
			(dvbc_read_reg(QAM_BASE + 0x0e8) | (1 << 2)));

	/* clear irq status */
	dvbc_read_reg(QAM_BASE + 0xd4);

	/* enable irq */
	dvbc_write_reg(QAM_BASE + 0xd0, 0x7fff << 3);
...
void dvbc_isr(struct aml_demod_sta *demod_sta)
{
	...
	stat = dvbc_read_reg(QAM_BASE + 0xd4);
	mask = dvbc_read_reg(QAM_BASE + 0xd0);
	stat &= mask;
...
#define IN_SYNC4_MASK (0x80)
	...
	stat = dvbc_read_reg(QAM_BASE + 0xd4);
	dvbc_write_reg(QAM_BASE + 0xd4, 0);
	mask = dvbc_read_reg(QAM_BASE + 0xd0);
	stat &= mask;
