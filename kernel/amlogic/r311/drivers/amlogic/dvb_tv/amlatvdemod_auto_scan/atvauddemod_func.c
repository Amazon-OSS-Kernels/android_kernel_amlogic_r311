...
static int nicam_detect_delay = 10;
module_param(nicam_detect_delay, int, 0644);
MODULE_PARM_DESC(nicam_detect_delay, "\n nicam_detect_delay for nicam detect delay\n");

static int a2_detect_delay = 300;
module_param(a2_detect_delay, int, 0644);
MODULE_PARM_DESC(a2_detect_delay, "\n a2_detect_delay for a2 detect delay\n");
...
static unsigned int audio_a2_auto = 1;
module_param(audio_a2_auto, uint, 0644);
MODULE_PARM_DESC(audio_a2_auto, "\n audio_a2_auto\n");

static unsigned int audio_a2_power_threshold = 0x1800;
module_param(audio_a2_power_threshold, uint, 0644);
MODULE_PARM_DESC(audio_a2_power_threshold, "\n audio_a2_power_threshold\n");

static unsigned int audio_a2_carrier_report = 0xc00;
module_param(audio_a2_carrier_report, uint, 0644);
MODULE_PARM_DESC(audio_a2_carrier_report, "\n audio_a2_carrier_report\n");
...
int atvaudio_ctrl_read(unsigned int *val)
{
	...
	if (audio_demod_reg_base)
		*val = readl(audio_demod_reg_base);
...
int atvaudio_ctrl_write(unsigned int val)
{
	...
	/* bit2: L/R swap for adec audio data */
	if (audio_demod_reg_base)
		writel(val, audio_demod_reg_base);
