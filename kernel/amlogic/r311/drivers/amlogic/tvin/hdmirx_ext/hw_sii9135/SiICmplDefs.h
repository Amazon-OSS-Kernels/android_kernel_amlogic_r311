...
#else
#define SII_XCLOCK_OSC_SCALED_AND_MUL100 (0xA77E515D)
#endif
/*   ( F_OSC * 100  * 1016 ) / 1024
...
#else
#define SII_XCLOCK_OSC_SCALED2047_AND_MUL100 (0xA8CFF140)
#endif
...
#else
#define SII_XCLOCK_OSC_SCALED_AND_MUL100 (0x9FB1DC87)
#endif
/*   ( F_OSC * 100  * 1016 ) / 1024
