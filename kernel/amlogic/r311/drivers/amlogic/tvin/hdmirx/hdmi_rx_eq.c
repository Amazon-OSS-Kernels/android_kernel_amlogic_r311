...
void rx_eq_setting(int rx_port_sel, int ch0Setting,
...
/***********************************/
/* func: rx_need_eq_algorithm */
/* return 0:  need run eq */
/* return 1:  use EQ default value */
/* return 2:  do nothing */
/***********************************/
enum eq_states_e rx_need_eq_algorithm(void)
{
	...
	if (EQ_MANUAL == ret)
		rx_eq_setting(rx.port, eq_ch0.bestsetting,
			eq_ch1.bestsetting, eq_ch2.bestsetting);
	else if (EQ_ENABLE == ret) {
		hdmirx_wr_phy(PHY_MAIN_FSM_OVERRIDE2, 0x0);
