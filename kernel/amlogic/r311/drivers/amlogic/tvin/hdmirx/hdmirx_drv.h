...
#define RX_VER0 "Ref.2018/07/18"
/*------------------------------*/

#define RX_VER1 "Ref.2018/05/25"
/*------------------------------*/
#ifdef CONFIG_AM_HDMI_AUDIO_FIFO
#define RX_VER2 "Ref.2019/03/15"
#else
#define RX_VER2 "Ref.2018/11/01"
#endif
/*------------------------------*/

#define RX_VER3 "Ref.2020/01/14"
/*------------------------------*/

#define RX_VER4 "Ref.2018/08/29"
/*------------------------------*/
...
struct rx_video_info {
	...
	unsigned int active_valid;
	unsigned int active_ratio;
	unsigned int bar_valid;
	unsigned int scan_info;
	unsigned int colorimetry;
	unsigned int picture_ratio;
	unsigned int ext_colorimetry;
	unsigned int n_uniform_scale;
	unsigned int bar_end_top;
	unsigned int bar_start_bottom;
	unsigned int bar_end_left;
	unsigned int bar_start_right;
	bool sw_fp;
	bool sw_alternative;
};
...
extern unsigned int aspect_ratio_val;
...
extern unsigned char rx_get_hdcp14_encrypted_sts(void);
