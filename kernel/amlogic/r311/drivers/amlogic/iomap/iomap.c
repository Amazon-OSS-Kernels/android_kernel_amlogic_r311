...
int notrace aml_reg_read(u32 bus_type, unsigned int reg, unsigned int *val)
{
...
int notrace aml_reg_write(u32 bus_type, unsigned int reg, unsigned int val)
{
	if (bus_type < IO_BUS_MAX) {
...
int notrace aml_regmap_update_bits(u32 bus_type,
...
*/
int notrace aml_read_cbus(unsigned int reg)
{
	int ret, val;
...
void notrace aml_write_cbus(unsigned int reg, unsigned int val)
{
	int ret;
...
void notrace aml_cbus_update_bits(unsigned int reg,
...
*/
int notrace aml_read_aobus(unsigned int reg)
{
	int ret, val;
...
void notrace aml_write_aobus(unsigned int reg, unsigned int val)
{
	int ret;
...
void notrace aml_aobus_update_bits(unsigned int reg,
		unsigned int mask, unsigned int val)
{
	int ret;
...
*/
int notrace aml_read_vcbus(unsigned int reg)
{
	int ret, val;
...
void notrace aml_write_vcbus(unsigned int reg, unsigned int val)
{
	int ret;
...
void notrace aml_vcbus_update_bits(unsigned int reg,
		unsigned int mask, unsigned int val)
{
	int ret;
...
*/
int notrace aml_read_dosbus(unsigned int reg)
{
	int ret, val;
...
void notrace aml_write_dosbus(unsigned int reg, unsigned int val)
{
	int ret;
...
void notrace aml_dosbus_update_bits(unsigned int reg,
		unsigned int mask, unsigned int val)
{
	int ret;
	ret = aml_regmap_update_bits(IO_APB_BUS_BASE,
