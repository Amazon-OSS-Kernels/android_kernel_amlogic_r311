...
{
	if (val == 1) { /* HDCP14_ENABLE */
		register unsigned int r0 asm("r0") = 0x82000010;
		asm volatile(
			__asmeq("%0", "r0")
			__SMC(0)
			: : "r"(r0)
	...
	if (val == 2) { /* HDCP14_RESULT */
		register unsigned int r0 asm("r0") = 0x82000011;
		asm volatile(
			__asmeq("%0", "r0")
			__SMC(0)
			: "+r"(r0)
	...
	if (val == 0) { /* HDCP14_INIT */
		register unsigned int r0 asm("r0") = 0x82000012;
		asm volatile(
			__asmeq("%0", "r0")
			__SMC(0)
			: : "r"(r0)
	...
	if (val == 3) { /* HDCP14_EN_ENCRYPT */
		register unsigned int r0 asm("r0") = 0x82000013;
		asm volatile(
			__asmeq("%0", "r0")
			__SMC(0)
			: : "r"(r0)
	...
	if (val == 4) { /* HDCP14_OFF */
		register unsigned int r0 asm("r0") = 0x82000014;
		asm volatile(
			__asmeq("%0", "r0")
			__SMC(0)
			: : "r"(r0)
	...
	if (val == 5) {	/* HDCP_MUX_22 */
		register unsigned int r0 asm("r0") = 0x82000015;
		asm volatile(
			__asmeq("%0", "r0")
			__SMC(0)
			: : "r"(r0)
	...
	if (val == 6) {	/* HDCP_MUX_14 */
		register unsigned int r0 asm("r0") = 0x82000016;
		asm volatile(
			__asmeq("%0", "r0")
			__SMC(0)
			: : "r"(r0)
	...
	if (val == 7) { /* HDCP22_RESULT */
		register unsigned int r0 asm("r0") = 0x82000017;
		asm volatile(
			__asmeq("%0", "r0")
			__SMC(0)
			: "+r"(r0)
	...
	if (val == 0xa) { /* HDCP14_KEY_LSTORE */
		register unsigned int r0 asm("r0") = 0x8200001a;
		asm volatile(
			__asmeq("%0", "r0")
			__SMC(0)
			: "+r"(r0)
	...
	if (val == 0xb) { /* HDCP22_KEY_LSTORE */
		register unsigned int r0 asm("r0") = 0x8200001b;
		asm volatile(
			__asmeq("%0", "r0")
			__SMC(0)
			: "+r"(r0)
	...
	if (val == 0xc) { /* HDCP22_KEY_SET_DUK */
		register unsigned int r0 asm("r0") = 0x8200001c;
		asm volatile(
			__asmeq("%0", "r0")
			__SMC(0)
			: "+r"(r0)
