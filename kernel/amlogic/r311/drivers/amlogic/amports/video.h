...
extern bool di_free_mirror_mem(void);
extern bool di_force_free_mem(void);
...
extern void DI_VSYNC_WR_MPEG_REG(unsigned int addr, unsigned int val);
extern unsigned int vpp_read_di_pre_reg(unsigned int adr);
