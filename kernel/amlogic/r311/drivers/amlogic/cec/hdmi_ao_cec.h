...
#define CEC_DRV_VESION			"2018/9/6\n"
#define CEC_FUNC_MASK			0
#define ONE_TOUCH_PLAY_MASK		1
#define ONE_TOUCH_STANDBY_MASK		2
#define AUTO_POWER_ON_MASK		3
#define CEC_TIMER_STATE_CHECK		(1*HZ/100)/*10ms*/
...
#define CEC_HPD_MIN  120
#define CEC_HPD_MAX  300
#define CEC_HPD_VIEW_DELAY 1500
#define CEC_HPD_ACTIVE_DELAY 1500
#define CEC_PLUG_DELAY 3000
#define CEC_PROTECT_DELAY 5000
#define CEC_REQUEST_DELAY 50
...
struct cec_device_info_s {
	...
	unsigned int hpd_count;
	unsigned int hpd_timeout;
	unsigned char view;
...
#define AO_RTI_STATUS_REG0             ((0x00 << 2))
...
extern int cec_set_full_reset_flag(unsigned char val);
int __attribute__((weak))cec_set_full_reset_flag(unsigned char val)
{
	return 0;
}
...
extern unsigned int rx_get_plug_info(void);
extern void rx_get_hpd_info(unsigned int *hpd_info);
extern void rx_get_open_port(unsigned int *hpd_info);
extern void rx_get_phy_init(unsigned int *init);
