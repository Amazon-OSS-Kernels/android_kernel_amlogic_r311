...
{
	ATRACE_COUNTER("GE2D", 0); // fosmod_graphics_profiling oneline
...
int ge2d_wq_add_work(struct ge2d_context_s *wq)
{
	...
	ATRACE_COUNTER("GE2D", 1); // fosmod_graphics_profiling oneline
