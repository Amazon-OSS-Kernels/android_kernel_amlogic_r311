...
void ge2d_set_dp_gen(struct ge2d_dp_gen_s *cfg)
{
	...
	ge2d_reg_set_bits(GE2D_GEN_CTRL1,
		cfg->src1_gb_alpha, 0, 8);
...
void ge2d_set_cmd(struct ge2d_cmd_s *cfg)
{
	...
	ge2d_log_dbg("sc_hsc_en=%d,hsc_rpt_p0_num=%d,hsc_ini_phase=%x\n",
		cfg->sc_hsc_en, cfg->hsc_rpt_p0_num, cfg->hsc_ini_phase);
	ge2d_log_dbg("sc_vsc_en=%d,vsc_rpt_l0_num=%d,vsc_ini_phase=%x\n",
		cfg->sc_vsc_en, cfg->vsc_rpt_l0_num, cfg->vsc_ini_phase);
