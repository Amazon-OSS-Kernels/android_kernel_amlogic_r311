...
struct ve_pq_load_s {
	...
	unsigned int length;
	struct ve_pq_table_s amve_pq_table_s[12];
};
...
static inline bool is_dolby_vision_enable(void) {return false; }
static inline bool is_dolby_vision_on(void) {return false; }
static inline bool for_dolby_vision_certification(void) {return false; }
static inline void enable_dolby_vision(int enable) {return; }
static inline void set_dolby_vision_mode(int mode) {return; }
static inline int get_dolby_vision_mode(void) {return 0; }
static inline void dolby_vision_set_toggle_flag(int flag) {return; }
static inline int dolby_vision_wait_metadata(struct vframe_s *vf) {return 0; }
static inline int dolby_vision_pop_metadata(void) {return 0; }
static inline int dolby_vision_update_metadata(struct vframe_s *vf) {return 0; }
static inline int dolby_vision_process(struct vframe_s *vf,
	u32 display_size) {return 0; }
static inline void dolby_vision_init_receiver(void *pdev) {return; }
static inline void dolby_vision_vf_put(struct vframe_s *vf) {return; }
static inline struct vframe_s *dolby_vision_vf_peek_el(struct vframe_s *vf)
	{return NULL; }
static inline void dolby_vision_dump_setting(int debug_flag) {return; }
static inline void dolby_vision_dump_struct(void) {return; }
static inline void tv_dolby_vision_config(int config) {return; }
static inline void dolby_vision_update_pq_config(char *config) {return; }
static inline int dolby_vision_update_setting(void) {return 0; }
static inline bool is_dolby_vision_stb_mode(void) {return false; }
static inline void tv_dolby_vision_crc_clear(int flag) {return; }
static inline char *tv_dolby_vision_get_crc(u32 *len) {return NULL; }
static inline void tv_dolby_vision_insert_crc(bool print) {return; }
static inline int dolby_vision_check_hdr10(struct vframe_s *vf) {return 0; }
static inline void tv_dolby_vision_dma_table_modify(u32 tbl_id,
	uint64_t value) {return; }
static inline void tv_dolby_vision_efuse_info(void) {return; }
static inline int dolby_vision_parse_metadata(struct vframe_s *vf,
	bool toggle_flag) {return 0; }
extern void amvecm_wakeup_queue(void);
static inline void tv_dolby_vision_el_info(void) {return; }
#else
