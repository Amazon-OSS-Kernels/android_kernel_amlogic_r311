...
const static char *vend_name = "Amazom"; /* Max 8 bytes */
const static char *prod_desc = "FireTV"; /* Max 16 bytes */
...
static void ddc_init(void)
{
	...
	hdmitx_wr_reg(HDMITX_DWC_I2CM_SS_SCL_HCNT_0, 0x76);
	hdmitx_wr_reg(HDMITX_DWC_I2CM_SS_SCL_LCNT_1, 0);
	hdmitx_wr_reg(HDMITX_DWC_I2CM_SS_SCL_LCNT_0, 0x96);
