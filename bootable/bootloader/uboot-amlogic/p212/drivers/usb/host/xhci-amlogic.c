...
static void dwc3_core_soft_reset(struct dwc3 *dwc3_reg)
{
	...
	amlogic_usb2_phy_init(amlogic.usb2_phy,amlogic.u2_port_num);
	amlogic_usb3_phy_init(amlogic.usb3_phy,amlogic.u3_port_num);
	mdelay(100);
...
{
	amlogic_usb2_phy_exit(amlogic->usb2_phy,amlogic->u2_port_num);

	amlogic_usb3_phy_exit(amlogic->usb3_phy,amlogic->u3_port_num);
}
