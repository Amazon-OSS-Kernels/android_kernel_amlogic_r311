...
#define     PARTITION_RESERVED              (1*SZ_1M)  // 8MB
...
#define     MMC_RESERVED_SIZE               (8*SZ_1M)
...
#define	MMC_MODULUS_NAME		"random"
#define MODULUS_OFFSET	(SZ_1M * 7)
#define MODULUS_SIZE	(256 * 512)
#define MODULUS_BLOCK_SIZE		(512)
#define MODULUS_PATTERN		(0x12345678)
/*
