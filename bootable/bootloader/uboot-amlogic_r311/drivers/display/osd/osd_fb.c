...
void *video_hw_init(void)
{
	...
	/*
	 * sync the env for display 32bits amazon logo,
	 * the 2 envs cannot be prestored in board for now
	 */
	run_command("env default display_bpp", 0);
	run_command("env default display_color_index", 0);
