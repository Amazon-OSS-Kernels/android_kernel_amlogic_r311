...
static unsigned int kk[] = {
	...
	CONFIG_IR_REMOTE_POWER_UP_KEY_VAL10,
	CONFIG_IR_REMOTE_POWER_UP_KEY_VAL11,
	CONFIG_IR_REMOTE_POWER_UP_KEY_VAL12,
	CONFIG_IR_REMOTE_POWER_UP_KEY_VAL13,
	CONFIG_IR_REMOTE_POWER_UP_KEY_VAL14,
	CONFIG_IR_REMOTE_POWER_UP_KEY_VAL15,
	CONFIG_IR_REMOTE_POWER_UP_KEY_VAL16,
	CONFIG_IR_REMOTE_POWER_UP_KEY_VAL17,
	CONFIG_IR_REMOTE_POWER_UP_KEY_VAL18,
	CONFIG_IR_REMOTE_POWER_UP_KEY_VAL19,
...
/* re-calculate correct number of IR wakeup keys. */
#ifdef CONFIG_IR_REMOTE_POWER_UP_KEY_CNT
#undef CONFIG_IR_REMOTE_POWER_UP_KEY_CNT
#endif
#define CONFIG_IR_REMOTE_POWER_UP_KEY_CNT	(int)(sizeof(kk) / sizeof(kk[0]))
	...
	if (((readl(AO_MF_IR_DEC_STATUS)) >> 3) & 0x1) { /*to judge the frame whether is effective or not*/
			...
			for (j = 0; j < CONFIG_IR_REMOTE_POWER_UP_KEY_CNT; j++) {
					if ((power_key & IR_POWER_KEY_MASK) == kk[j])
							return kk[j]; /* return true remote key value because linux need it. */
			}
