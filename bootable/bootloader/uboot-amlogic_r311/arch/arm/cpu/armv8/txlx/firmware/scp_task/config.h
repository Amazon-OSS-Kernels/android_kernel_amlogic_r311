...
#define CONFIG_RAM_BASE        (0x10000000 + 42 * 1024)
...
#define SECURE_TASK_SHARE_MEM_BASE		0x1000DC00
#define SECURE_TASK_RESPONSE_MEM_BASE 0x1000DE00
#define HIGH_TASK_SHARE_MEM_BASE		(P_SHARE_SRAM_BASE + 70*1024)
#define HIGH_TASK_RESPONSE_MEM_BASE		(P_SHARE_SRAM_BASE + 70*1024 + 512)
#define LOW_TASK_SHARE_MEM_BASE			(P_SHARE_SRAM_BASE + 71*1024)
#define LOW_TASK_RESPONSE_MEM_BASE		(P_SHARE_SRAM_BASE + 71*1024 + 512)
/*
