/*
 * board/amlogic/configs/blanche32.h
 *
...
#define CONFIG_EXTRA_ENV_SETTINGS \
        ...
        "upgrade_check="\
            ...
            "\0"\
        "storeargs="\
            "setenv bootargs ${initargs} vmalloc=300M logo=${display_layer},loaded,${fb_addr} vout=${outputmode},enable panel_type=${panel_type} osd_reverse=${osd_reverse} video_reverse=${video_reverse} bl_level=${bl_level} bl_status=${bl_status} silent_ota=${silent_ota} reboot_mode=${reboot_mode} androidboot.selinux=${EnableSelinux} androidboot.firstboot=${firstboot} jtag=${jtag}; "\
