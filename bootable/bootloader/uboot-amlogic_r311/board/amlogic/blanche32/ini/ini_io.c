...
int ReadPanelMiscInfo(char data_buf[]) {
    return ReadStringData(CS_PANEL_MISC_INFO_ITEM_NAME, 1, data_buf);
}

int SavePanelMiscInfo(char data_buf[]) {
    return SaveStringData(CS_PANEL_MISC_INFO_ITEM_NAME, 1, data_buf);
}
