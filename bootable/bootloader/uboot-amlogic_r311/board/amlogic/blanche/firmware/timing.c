/*
 * board/amlogic/blanche/firmware/timing.c
 *
...
#define CFG_DDR4_ODT  DDR4_ODT_60OHM//DDR4_ODT_48OHM// DDR4_ODT_80OHM //ddr4 driver use this one
#define CONFIG_SOC_VREF   0// 1+ (50+((50*48)/(48+480/(6+1)))) // 880/12  //(50+((50*48)/(48+160)))  //0//50+50*drv/(drv+odt)  (738/12) //0 //0  is auto --70 ---range 44.07---88.04   %
#define CONFIG_DRAM_VREF  0// 1+ (50+((50*37)/(37+48)))// 860/12 // 0// (810/12) // 0 //77 //0 //0  is auto ---70 --range -- 45---92.50    %
...
ddr_set_t __ddr_setting = {
	...
	*/
	...
	.rd_adj_per				= {
	 ...
	 .t_pub_acbdlr0_1=0x10,
	 .t_pub_acbdlr3_1=0x10,
	 .t_pub_aclcdlr_1=0x50,
};
...
pll_set_t __pll_setting = {
	...
	/*
	 * ddr pll ssc config:
	 * ppm1000 center : 0x00120000
	 * ppm2000 center : 0x00140000
	 * ppm3000 center : 0x00160000
	 * ppm4000 center : 0x00180000
	 * ppm5000 center : 0x001A0000
	 * ppm6000 center : 0x001C0000
	 */
	.ddr_pll_set[0]			= 0x00160000,
};
