...
ifneq ($(wildcard $(BUILD_OPTEE_MK)),)
LOCAL_PATH := $(call my-dir)
TDK_PATH ?= $(BOARD_AML_VENDOR_PATH)/tdk_v38
CFG_TEEC_PUBLIC_PATH = $(TDK_PATH)/ca_export_$(TARGET_ARCH)

## include variants like TA_DEV_KIT_DIR
## and OPTEE_BIN
LOCAL_INCLUDE_FOR_BUILD_OPTEE_TA := false
include $(BUILD_OPTEE_MK)
LOCAL_INCLUDE_FOR_BUILD_OPTEE_TA := true
...
include $(CLEAR_VARS)
LOCAL_MODULE := ta_memory
LOCAL_VENDOR_MODULE := true
LOCAL_MODULE_TAGS := optional
LOCAL_SHARED_LIBRARIES := libteec

LOCAL_C_INCLUDES = $(CFG_TEEC_PUBLIC_PATH)/include
LOCAL_SRC_FILES = host/xtest/ta_memory.c
